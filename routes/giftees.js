...
router.post('/', function(req, res, next) {
  ...
  knex('giftees').insert({creator_id: req.body.creator_id, first_name: req.body.first_name, last_name: req.body.last_name, relationship: req.body.relationship, budget: parseInt(req.body.budget), email: req.body.email, age: req.body.age, birthday: req.body.birthday, birthdate: req.body.birthdate, xmas: req.body.xmas, hanukka: req.body.hanukka, mothersday: req.body.mothersday, fathersday: req.body.fathersday, valentines: req.body.valentines, anniday: req.body.anniday, annidate: req.body.annidate}).returning("*").then(data => {
