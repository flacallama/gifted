  ...
  return knex('giftees').del()
    .then(function () {
      ...
      return knex('giftees').insert([
        ...
        {creator_id: 1, first_name: 'Suzy', last_name: "Simford", relationship: 'sister', budget: "$0-$14", email: 'test@test.com', age: 24, birthday: true, birthdate: '2017-03-07T16:46:38.855Z', birthday_price: 45, xmas: true, xmas_price: 40, hanukka: false, hanukka_price: null, mothersday: false, fathersday: false, valentines: true, valentines_price: 15, anniday: true, annidate: '2017-12-31T16:46:38.855Z', anniday_price: 55},
        {creator_id: 1, first_name: 'Lisa', last_name: "Simford", relationship: 'niece', budget: "$0-$14", email: 'test@test.com', age: 44, birthday: true, birthdate: '2017-11-20T16:46:38.855Z', birthday_price: 15, xmas: true, xmas_price: 20, hanukka: false, hanukka_price: null, mothersday: false, fathersday: false, valentines: true, valentines_price: 10, anniday: true, annidate: '2017-08-31T16:46:38.855Z', anniday_price: 55}
      ]);
    });
};
