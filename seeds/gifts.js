  ...
  return knex('gifts').del()
    .then(function () {
      ...
      return knex('gifts').insert([
        ...
        {creator_id: 1, giftee_id: 2, idea: "Necktie", idea_notes: 'Ill never wear this', is_past: true, date_given: 12/25/12, received: true, graduation: true},
        ...
        {creator_id: 1, giftee_id: 3, idea: "certificate to Olive Garden", idea_notes: 'He said to enjoy the breadscticks', is_past: true, date_given: 12/25/12, received: true, birthday: true},
